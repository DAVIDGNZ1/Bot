...
const vcard2 = 'BEGIN:VCARD\n' 
              ...
              + 'FN:DAVID BOTツ\n' //ganti nama lu! 
              + 'ORG: Owner YD-BOT;\n' 
              + 'TEL;type=CELL;type=VOICE;waid=6287880120452:+6287880120452\n'  //ganti nomor lu! 
              + 'END:VCARD'
...
//owner number
const ownerNumber = ["6289696332613@s.whatsapp.net","6285876330812@s.whatsapp.net"]   //ganti nomor lu! 
const dappNumber = ["6287880120452@s.whatsapp.net"]  //ganti nomor lu!  
		...
		case 'menu':
            //Gak Usah Di Hapus TQTO Gblk Dimana Harga Diri Lu Gw Capek2 Ngefix malah di hapus 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    ...
                    wew = fs.readFileSync(`./src/Menu.jpg`)
                    yogi = `╔═══[ *DATA DATA SASUKE BOT* ]
│
│ ♡ۣۜۜ፝͜͜͡͡✿➤ Nama: Sasuke Bot
│ ♡ۣۜۜ፝͜͜͡͡✿➤ Version: 3.0
│ ♡ۣۜۜ፝͜͜͡͡✿➤ Owner: DavidGnz
...
//ownermenu
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*「 BROADCAST SASUKE BOT 」*\n\n${body.slice(4)}`)
						}
						reply('*Suksess broadcast* ')
					}
					break
